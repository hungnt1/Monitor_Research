...
- Khởi tạo  nvdia.py tại /opt/collectd/python/nvsmi.py
```
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
- Thêm cấu hình collectd  load plugin  và gửi về graphite /etc/collectd/collectd.conf.d/nvdia.conf
```
