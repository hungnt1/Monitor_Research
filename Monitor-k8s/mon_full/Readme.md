![](https://phoenixnap.com/kb/wp-content/uploads/2020/01/prometheus-kubernetes-architechture-overview.png)
...
2. Deployment: 
    ...
    - Deploy cadvisor: `kubectl apply -f k8s/monitoring/cadvisor`
